...
- Designed a data-governance pipeline allowing dataset owners to publish declarative data access schemas via YAML to AWS S3, using OAuth 2.0 protocol to parse user context and dynamically enforce schema-level boundaries across HDFS and Snowflake queries.
